...
namespace Entidades.Clases_Generales
{
    ...
    {  
        ...
        public List<Celular> ListaEnsamblados
        {
            get
            {
                return this.Ensamblados.ListaCelulares();
            }
        }


        public List<Celular> ListaAReparar
        {
            get
            {
                return this.DepositoAReparar.ListaCelulares();
            }
        }

        public List<Celular> ListaOk
        {
            get
            {
                return this.DepositoOk.ListaCelulares();
            }
        }
        /// <summary>
